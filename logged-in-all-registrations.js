                            ...
                            React.createElement(
                                ...
                                allUsers.map((u) => (
                                    React.createElement(
                                        ...
                                        React.createElement('td', { className: 'py-3 px-6 text-left whitespace-nowrap' }, u.email || 'N/A'),
                                        React.createElement('td', { className: 'py-3 px-6 text-left' }, u.firstName || 'N/A'),
                                        React.createElement('td', { className: 'py-3 px-6 text-left' }, u.lastName || 'N/A'),
                                        React.createElement('td', { className: 'py-3 px-6 text-left' }, u.contactPhoneNumber || 'N/A'),
                                        React.createElement('td', { className: 'py-3 px-6 text-left' }, u.role || 'N/A'),
                                        React.createElement('td', { className: 'py-3 px-6 text-left' }, u.approved ? 'Áno' : 'Nie'),
                                        React.createElement('td', { className: 'py-3 px-6 text-left' }, u.registrationDate || 'N/A'),
                                        React.createElement('td', { className: 'py-3 px-6 text-left' }, u.passwordLastChanged || 'N/A'),
                                        React.createElement('td', { className: 'py-3 px-6 text-left' }, u.billing?.clubName || 'N/A'),
                                        React.createElement('td', { className: 'py-3 px-6 text-left' }, u.billing?.ico || 'N/A'),
                                        React.createElement('td', { className: 'py-3 px-6 text-left' }, u.billing?.dic || 'N/A'),
                                        React.createElement('td', { className: 'py-3 px-6 text-left' }, u.billing?.icDph || 'N/A'),
                                        React.createElement('td', { className: 'py-3 px-6 text-left' }, u.street || 'N/A'),
                                        React.createElement('td', { className: 'py-3 px-6 text-left' }, u.houseNumber || 'N/A'),
                                        React.createElement('td', { className: 'py-3 px-6 text-left' }, u.city || 'N/A'),
                                        React.createElement('td', { className: 'py-3 px-6 text-left' }, u.postalCode || 'N/A'),
                                        React.createElement('td', { className: 'py-3 px-6 text-left' }, u.country || 'N/A')
                                    )
                                ))
                            )
                        )
