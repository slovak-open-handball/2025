// register-page1.js
// Tento súbor obsahuje komponenty a logiku pre prvú stránku registračného formulára.
...
// Page1Form Component
function Page1Form({ formData, handleChange, handleNext, loading, notificationMessage, closeNotification, isCountryCodeModalOpen, setIsCountryCodeModalOpen, setSelectedCountryDialCode, selectedCountryDialCode, PasswordInput, NotificationModal }) {
...
// Export the components and countryCodes for use in other files
export { Page1Form, CountryCodeModal, countryCodes };
