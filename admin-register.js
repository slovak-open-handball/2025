...
import { collection, doc, setDoc, addDoc, serverTimestamp, onSnapshot, getDoc, runTransaction, increment } from "https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";
...
const MAX_AUTO_APPROVED_ADMINS = 1;
        ...
        await runTransaction(db, async (transaction) => {
          ...
          if (approvedStatus) {
            ...
            if (settingsDoc.exists()) {
              ...
              // Ak dokument neexistuje, vytvorte ho s počiatočnou hodnotou 1
              transaction.set(settingsDocRef, { count: 1 });
            }
          }
        });
        // --- Koniec transakcie ---
