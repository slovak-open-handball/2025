...
    const buttonClasses = px-4 py-2 rounded-md transition-colors ${ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;isButtonDisabled ? 'bg-white text-current border border-current' : 'text-white' &nbsp;&nbsp;&nbsp;&nbsp;};
    const buttonStyles = {
...
        onClose();
    };
    const buttonClasses = px-4 py-2 rounded-md transition-colors ${ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;isButtonDisabled || !isDateOfBirthValid ? 'bg-white text-current border border-current' : 'text-white' &nbsp;&nbsp;&nbsp;&nbsp;};
    const buttonStyles = {
...
    const hourOptions = Array.from({ length: 24 }, (*, i) => String(i).padStart(2, '0'));
    const minuteOptions = Array.from({ length: 60 }, (*, i) => String(i).padStart(2, '0'));
    const handleAddTshirtEntry = () => {
        setTshirtEntries([...tshirtEntries, { size: '', quantity: 1 }]);
        setHasChanges(true);
    };
    const handleRemoveTshirtEntry = (index) => {
        setTshirtEntries(tshirtEntries.filter((*, i) => i !== index));
        setHasChanges(true);
    };
...
        setHasChanges(true);
    };
    const saveButtonClasses = px-4 py-2 rounded-md transition-colors ${ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;isSaveButtonDisabled ? 'bg-white text-current border border-current' : 'text-white' &nbsp;&nbsp;&nbsp;&nbsp;};
...
    };
    const addTshirtButtonClasses = flex items-center justify-center w-8 h-8 rounded-full transition-colors focus:outline-none focus:ring-2 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${isAddTshirtButtonDisabled &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;? 'bg-white border border-solid' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: 'bg-blue-500 text-white hover:bg-blue-600 focus:ring-blue-500' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;};
...
    };
    if (!show) return null;
    const buttonClasses = px-4 py-2 rounded-md transition-colors ${ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;isSaveButtonDisabled ? 'bg-white text-current border border-current' : 'text-white' &nbsp;&nbsp;&nbsp;&nbsp;};
    const buttonStyles = {
        backgroundColor: isSaveButtonDisabled ? 'white' : roleColor,
        color: isSaveButtonDisabled ? roleColor : 'white',
        borderColor: isSaveButtonDisabled ? roleColor : 'transparent',
...
        modal.innerHTML =  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="relative p-8 bg-white w-full max-w-sm mx-auto rounded-lg shadow-lg"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h3 class="text-xl font-semibold mb-4 text-gray-800">Potvrdiť vymazanie tímu</h3> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p class="mb-6 text-gray-700">Naozaj chcete vymazať tím <strong>${teamToDelete.teamName}</strong>? Táto akcia je nevratná.</p> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="flex justify-end space-x-2"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button id="cancelDelete" class="px-4 py-2 bg-gray-300 text-gray-800 rounded-md hover:bg-gray-400 transition-colors">Zrušiť</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button id="confirmDelete" class="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition-colors">Vymazať</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;;
