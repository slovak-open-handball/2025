...
// { className: 'w-full bg-white rounded-xl shadow-xl p-8 mx-4' },
                ...
                React.createElement(
                    ...
                    filteredUnassignedMatches.length > 0 && React.createElement(
                       ...
                       // PRAVÝ STĹPEC - Športové haly (OPRAVENÉ - boxy hál vedľa seba, boxy dní pod sebou)
                       React.createElement(
                           'div',
                           ...
                           // Grid zoznam športových hál - boxy hál vedľa seba (flex-wrap)
                           !loading && sportHalls.length > 0 && React.createElement(
                               'div',
                               { 
                               ...
                               sortedFilteredSportHalls.map((hall) => {
                                   ...
                                   return React.createElement(
                                       ...
                                       { 
                                           ...
                                           style: { 
                                               width: 'calc(33.333% - 1rem)', // Tri boxy hál vedľa seba
                                               minWidth: '350px'
                                           }
                                       },
                                       React.createElement(
