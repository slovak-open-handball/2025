                                                                    ...
                                                                    React.createElement(
                                                                        ...
                                                                        React.createElement(
                                                                            ...
                                                                            displayMode === 'both' && React.createElement(
                                                                                'div',
                                                                                { 
                                                                                    className: `text-gray-500 font-mono text-[10px] whitespace-nowrap min-w-[250px] flex-shrink-0 px-2 border-r border-gray-300`, // ZMENENÉ: pridané px-2 a border-r
                                                                                    style: alignmentStyle
                                                                                },
                                                                                `(${homeDisplay.id})`
                                                                            ),
                                                                            ...
                                                                            displayMode === 'both' && React.createElement(
                                                                                'div',
                                                                                { 
                                                                                    className: `text-gray-500 font-mono text-[10px] whitespace-nowrap min-w-[250px] flex-shrink-0 px-2`, // ZMENENÉ: pridané px-2, BEZ border-r (posledná bunka)
                                                                                    style: alignmentStyle
                                                                                },
                                                                                `(${awayDisplay.id})`
                                                                            ),
                                                                            ...
                                                                            displayMode !== 'both' && React.createElement('div', { className: 'min-w-[250px] flex-shrink-0 px-2' }) // ZMENENÉ: pridané px-2
                                                                        ),
