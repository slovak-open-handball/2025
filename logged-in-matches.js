...
// { className: 'w-full bg-white rounded-xl shadow-xl p-8 mx-4' },
                ...
                React.createElement(
                    ...
                    filteredUnassignedMatches.length > 0 && React.createElement(
                       ...
                       // PRAVÝ STĹPEC - Športové haly (OPRAVENÉ - boxy hál vedľa seba s pevnou šírkou 695px, žiadne zalamovanie)
                       React.createElement(
                           'div',
                           { className: `${filteredUnassignedMatches.length > 0 ? 'lg:w-2/3' : 'lg:w-full'} flex flex-col overflow-x-auto` },
                           (() => {
                           ...
                           // Grid zoznam športových hál - boxy hál vedľa seba s horizontálnym posuvníkom, žiadne zalamovanie
                           !loading && sportHalls.length > 0 && React.createElement(
                               'div',
                               { 
