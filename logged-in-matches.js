...
// { className: 'w-full bg-white rounded-xl shadow-xl p-8 mx-4' },
                ...
                React.createElement(
                    ...
                    filteredUnassignedMatches.length > 0 && React.createElement(
                       ...
                       // Nahraďte existujúci PRAVÝ STĹPEC - Športové haly (od riadku približne 4400) týmto kódom:

                       // PRAVÝ STĹPEC - Športové haly (OPRAVENÉ - boxy hál vedľa seba s horizontálnym posuvníkom, boxy dní pod sebou)
                       React.createElement(
                           'div',
                           ...
                           // Grid zoznam športových hál - boxy hál vedľa seba s horizontálnym posuvníkom
                           !loading && sportHalls.length > 0 && React.createElement(
                               'div',
                               { 
                                   ...
                                   sortedFilteredSportHalls.map((hall) => {
                                       ...
                                       return React.createElement(
                                           ...
                                           { 
                                               ...
                                               style: { 
                                                   width: '630px', // Pevná šírka pre každý box haly
                                                   minWidth: '630px'
                                               }
                                           },
                                           React.createElement(
