...
const renderCategoryView = (categoryId = null) => {
    // Ak nemáme categoryId, nemáme čo zobraziť
    if (!categoryId) {
        return React.createElement(
            'div',
            { className: 'w-full text-center py-16' },
            React.createElement('p', { className: 'text-xl text-gray-500' }, 
                'Vyberte kategóriu pre zobrazenie skupín'
            )
        );
    }
...
return React.createElement(
    ...
    React.createElement(
        ...
        // Ak je vybratá kategória, zobrazíme karty skupín
        selectedCategoryId
            ...
            : React.createElement(
                ...
                // Správa, že treba vybrať kategóriu
                React.createElement(
                    'div',
                    { className: 'flex-grow flex items-center justify-center min-h-96' },
                    React.createElement(
                        'div',
                        { className: 'text-center' },
                        React.createElement('h3', { className: 'text-2xl font-semibold mb-4 text-gray-700' }, 'Vyberte kategóriu'),
                        React.createElement('p', { className: 'text-gray-600' }, 'Pre zobrazenie skupín a tímov vyberte kategóriu z rozbaľovacieho zoznamu vyššie.')
                    )
                )
            ),
        fabButton
