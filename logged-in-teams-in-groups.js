...
const AddGroupsApp = (props) => {
    ...
    // ===================================================================
    // VNÚTORNÉ FUNKCIE – všetky majú prístup k setNotification, categoryIdToNameMap atď.
    // ===================================================================
    ...
    const handleUpdateTeam = async ({ categoryId, groupName, teamName, order, originalTeam }) => {
        ...
        try {
            ...
            let targetTeams = categoryChanged ? [...(data[newCategoryName] || [])] : oldTeams;
            let newOrder = null;
    ...
    const notificationClasses = `fixed top-4 left-1/2 -translate-x-1/2 px-6 py-3 rounded-lg shadow-xl text-white text-center transition-opacity duration-300 transform z-50 flex items-center justify-center ${
