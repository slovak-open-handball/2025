...
const handleDrop = async (e, targetGroup, targetCategoryId) => {
    ...
    try {
        if (!teamData.isSuperstructureTeam) {
            ...
            // Zvýšenie hodnoty order o +1 pre všetky tímy v cieľovej skupine, ktoré majú order >= finalOrder
            teams = teams.map(t => {
            ...
            // Vloženie presúvaného tímu na správnu pozíciu
            ...
            const targetDocPath = `users/${teamData.uid}`;
