    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(
                ...
                React.createElement('h2', { className: 'text-3xl font-bold tracking-tight text-center' }, 'Mapa')
            )
        )
    );
};
...
const handleDataUpdateAndRender = (event) => {
    ...
    if (userProfileData) {
                    ...
                    try {
                        ...
                        if (docSnap.exists()) {
                            ...
                            if (user.email !== firestoreEmail) {
                                ...
                                console.log("logged-in-map.js: E-mail vo Firestore bol aktualizovaný a notifikácia vytvorená.");
            
                            } else {
                                console.log("logged-in-map.js: E-maily sú synchronizované, nie je potrebné nič aktualizovať.");
                            }
                        }
                    } catch (error) {
                        console.error("logged-in-map.js: Chyba pri porovnávaní a aktualizácii e-mailu:", error);
        ...
        if (rootElement && typeof ReactDOM !== 'undefined' && typeof React !== 'undefined') {
            ...
            console.error("logged-in-map.js: HTML element 'root' alebo React/ReactDOM nie sú dostupné.");
        }
    } else {
        ...
        console.error("logged-in-map.js: Dáta používateľa nie sú dostupné v udalosti 'globalDataUpdated'. Zobrazujem loader.");
    }
};
...
console.log("logged-in-map.js: Kontrolujem, či existujú globálne dáta.");
