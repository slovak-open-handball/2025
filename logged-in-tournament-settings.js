...
import { getFirestore, doc, onSnapshot, setDoc, Timestamp, updateDoc, arrayUnion, arrayRemove, getDoc, collection, addDoc, deleteDoc, collection, getDocs } from "https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";
        ...
        const checkAndHandleHashChange = (newHash) => {
          ...
          if (activeSetting === 'categories' && 
            ...
            setModalState({
              isOpen: true,
              pendingAction: () => {
                  console.log("pendingAction - spúšťam reset a prepnutie sekcie");
