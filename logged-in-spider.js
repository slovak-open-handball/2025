...
const SpiderApp = ({ userProfileData }) => {
    ...
    // ... (renderLevel1, renderLevel2, renderLevel3, renderLevel4 funkcie sú rovnaké, preto sú vynechané kvôli stručnosti) ...
    ...
    // NOVÝ STAV: Existencia ukončeného zápasu v systéme
