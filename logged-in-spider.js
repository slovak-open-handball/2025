                                ...
                                spiderLevel === 2 && React.createElement(
                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement(
                                            ...
                                            // Zvislá čiara na 33.33% z ľavej strany (prvá tretina)
                                            React.createElement('div', { 
                                                className: 'spider-line-vertical',
                                                style: { 
                                                    left: '33.33%',
                                            ...
                                            // Zvislá čiara na 33.33% z pravej strany (dve tretiny)
                                            React.createElement('div', { 
                                                className: 'spider-line-vertical',
                                                style: { 
                                                    left: '66.66%',
                                            ...
                                            // Vodorovná čiara v strede od 33.33% z pravej do 33.33% z ľavej
                                            React.createElement('div', { 
                                                style: {
                                                    position: 'absolute',
                                                    height: '2px',
