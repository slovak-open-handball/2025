 ...
 */
const MyDataApp = ({ userProfileData: initialData, roleColor }) => {
    ...
    useEffect(() => {
        // Inicializácia a nastavenie listeneru na zmeny v globálnych dátach
...
// Vykreslenie aplikácie po načítaní dát
document.addEventListener('globalDataUpdated', (event) => {
