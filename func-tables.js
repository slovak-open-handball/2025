...
//                log(`📋 Kontumovaný výsledok pre ${match.homeTeamIdentifier} vs ${match.awayTeamIdentifier}: ${homeScore}:${awayScore}`);
    ...
    function createAdvancedGroupTable(categoryName, groupName, baseGroupName) {
        ...
        if (carryOverEnabled) {
            ...
            // ============================================================
            // 🔥 NOVÝ PRÍSTUP: Pre každú dvojicu tímov v nadstavbovej skupine
...
uprav prosím v prvom kode, prosím si len upravene casti kodu:

ak sa spracovavaju zápasy pre skupinu, musí z db vedieť, o aký typ skupiny ide, či je zákkladná, alebo nadstavbová, toto sa nasatvuje v tomto kode do db:
